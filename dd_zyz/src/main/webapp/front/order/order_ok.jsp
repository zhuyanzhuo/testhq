	...
	<head>
		...
		<script type="text/javascript">
						var count = 6;
							...
							count--;
							if(count == 0){
								window.location.href="${pageContext.request.contextPath }/FrontFirstView/removeTotal";
							}else{
								$("#aa").html(count);
		...
		<div class="login_success">
			<div class="login_bj">
				...
				<ul>
					...
					<li>
						<a href="${pageContext.request.contextPath }/FrontFirstView/removeTotal">继续浏览并选购商品</a>
					</li>
				</ul>
			</div>
		</div>
